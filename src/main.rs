...
mod menu {
    ...
    use crate::{MAIN_MENU_HEIGHT, MAIN_MENU_WIDTH};
    ...
    const NORMAL_BUTTON: Color = Color::rgb(0.1, 0.15, 0.15);
    const HOVERED_BUTTON: Color = Color::rgb(0.1, 0.25, 0.25);
    const HOVERED_PRESSED_BUTTON: Color = Color::rgb(0.35, 0.3, 0.45);
    const PRESSED_BUTTON: Color = Color::rgb(0.2, 0.3, 0.65);
    ...
    fn main_menu_setup(mut commands: Commands, asset_server: Res<AssetServer>) {
        let font = asset_server.load("fonts/VT323/VT323-Regular.ttf");
        // Common style for all buttons on the screen
        let button_style = Style {
            size: Size::new(Val::Px(MAIN_MENU_HEIGHT), Val::Px(MAIN_MENU_WIDTH)),
